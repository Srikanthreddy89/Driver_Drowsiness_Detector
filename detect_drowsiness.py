...
model = load_model("drowsiness_best.h5")
count = 0
alarm_on = False
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        for (x1, y1, w1, h1) in left_eye:
            ...
            # making the same augmentation changes as the dataset
        ...
        if status1 == 0 and status2 == 0:
            count += 1
            cv2.putText(frame, "Detected Closed Eyes", (10, 30), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 1)
            if count >= 2:
